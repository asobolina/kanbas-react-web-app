    ...
    <div id="wd-assignments-editor" className="container mt-4">
      ...
      <div className="row mb-3">
        <div className="col-lg-12">
          ...
          <textarea id="wd-description" className="form-control" defaultValue="The assignment is available online. Submit a link to the landing page of"></textarea>
        </div>
      </div>
      ...
      <div className="row">
        <div className="col-lg-6">
          ...
          <div className="d-flex justify-content-end">
            ...
            <button className="btn btn-primary bg-danger border-danger">Save</button>
          </div>
        </div>
      </div>
    </div>
